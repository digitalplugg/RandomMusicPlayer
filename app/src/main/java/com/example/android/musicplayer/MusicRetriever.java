...
// TODO: this was not found after removing support for platform < 4.2.2 - when
// adding code to correct deprecated Notification method - see below
...
public class MusicRetriever {
    ...
    public void prepare() {
        ...
        // OM-MOD: TODO: Testing how to include USB storage media files in the search...
        // After I added this line of code, and ran debug, the app did (on its own added the mp3 files
        // in the USB thumb drive!! - Not sure why! Unless the system automatically adds found
        // media items to Media.EXTERNAL_CONTENT_URI

        Uri uri2 = MediaStore.Audio.Media.getContentUriForPath("/storage/usb1/");
